...
LOCKED_ROOT="$REPO_ROOT/01_SOURCE_TRUTH_LOCKED/rc-20260814.2"
...
required_files=(index.html js/gridnode-bundle.js js/gridnode-core.js js/gridnode-phase-sphere.js js/gridnode-product-completion.js js/gridnode-peptide-pk.js js/gridnode-peptide-viz.js sw.js manifest.json _headers)
...
printf '%s\n' '== JavaScript syntax =='
node --check "$REPO_ROOT/js/gridnode-core.js"
