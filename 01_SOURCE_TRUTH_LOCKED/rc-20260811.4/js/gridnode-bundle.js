...
function renderScanner() {
  ...
  qa('.gn-zone-path').forEach(path => {
    ...
    path.classList.toggle('selected', site === moduleState.selectedLocation);
    path.classList.toggle('selected-active', site === moduleState.selectedLocation && visible);
...
function registerServiceWorker() {
  ...
  navigator.serviceWorker
    .register('/sw.js?v=20260811.4', { updateViaCache: 'none' })
