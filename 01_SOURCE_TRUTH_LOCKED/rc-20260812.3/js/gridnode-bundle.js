...
function setScannerMode(mode, button) {
  ...
  if (asset) {
    ...
    asset.src = `/assets/scanner/${folder}/${folder}-${skinTone}.png`;
...
function renderScanner() {
  ...
  if (_asset) {
    ...
    const _desired = `/assets/scanner/${_folder}/${_folder}-${_skinTone}.png`;
...
function registerServiceWorker() {
  ...
  navigator.serviceWorker
    .register('/sw.js?v=20260812.3', { updateViaCache: 'none' })
