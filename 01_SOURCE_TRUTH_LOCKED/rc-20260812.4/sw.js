...
const CACHE_NAME = 'gridnode-shell-20260812-4';
const V = '?v=' + RELEASE;
const SHELL = [
  '/',
  ...
  '/assets/scanner/legs/legs-light.webp',
  '/assets/scanner/legs/legs-medium.webp',
  '/assets/scanner/legs/legs-deep.webp',
  '/assets/scanner/arms/arms-light.webp',
  '/assets/scanner/arms/arms-medium.webp',
  '/assets/scanner/arms/arms-deep.webp'
];
