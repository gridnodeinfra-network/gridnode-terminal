 ...
 */
const CACHE_NAME = 'gridnode-shell-20260802-01';
const SHELL = ['/', '/index.html', '/manifest.json', '/assets/gridnode-icon.svg', '/assets/scanner-body-rear.jpg', '/js/gridnode-bundle.js?v=20260802.1', '/js/gridnode-native.js?v=20260802.1', '/css/gridnode-native.css?v=20260802.1'];
