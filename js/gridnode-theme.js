(() => {
  ...
  var THEME_NIGHT_SVG = '<svg class="gn-theme-svg gn-theme-svg-night" viewBox="0 0 24 24" width="19" height="19" fill="none" aria-hidden="true"><rect x="9" y="3" width="6" height="18" rx="1" fill="currentColor" opacity=".55"/><rect x="7" y="14" width="2" height="7" fill="currentColor" opacity=".3"/><rect x="15" y="11" width="2" height="10" fill="currentColor" opacity=".3"/><rect x="11" y="5" width="2" height="2" fill="#FF3B3B"/><rect x="9" y="9" width="2" height="2" fill="#FF3B3B" opacity=".7"/><rect x="13" y="14" width="2" height="2" fill="currentColor" opacity=".85"/><path d="M2 21h20" stroke="currentColor" stroke-width="1.4" opacity=".5"/></svg>';
